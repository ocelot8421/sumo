package hu.progmasters.oop.methods.privateclient;

/**
 * Hozz létre egy PrivateClient osztályt, melynek három attribútuma van:
 * név (name),
 * születési év (year) és
 * cím (address).
 * Típusaik rendre String, int és String. A láthatóságuk legyen privát.
 * <p>
 */
public class PrivateClientMain {
